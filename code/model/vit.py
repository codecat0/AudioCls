...
__all__ = ['VisionTransformer', 'vit_base_patch16_224_in21k', 'vit_base_patch32_224_in21k',
...
def vit_base_patch32_224_in21k(num_classes: int = 21843, has_logits: bool = True):
    """
    paper: https://arxiv.org/abs/2010.11929
    weights: https://github.com/rwightman/pytorch-image-models/releases/download/v0.1-vitjx/jx_vit_base_patch32_224_in21k-8db57226.pth
    """
    model = VisionTransformer(img_size=224,
                              patch_size=32,
                              embed_dim=768,
...
def vit_large_patch16_224_in21k(num_classes: int = 21843, has_logits: bool = True):
    """
    paper: https://arxiv.org/abs/2010.11929
    weights: https://github.com/rwightman/pytorch-image-models/releases/download/v0.1-vitjx/jx_vit_large_patch16_224_in21k-606da67d.pth
    """
    model = VisionTransformer(img_size=224,
                              patch_size=16,
                              embed_dim=1024,
...
def vit_large_patch32_224_in21k(num_classes: int = 21843, has_logits: bool = True):
    """
    paper: https://arxiv.org/abs/2010.11929
    weights: https://github.com/rwightman/pytorch-image-models/releases/download/v0.1-vitjx/jx_vit_large_patch32_224_in21k-9046d2e7.pth
    """
    model = VisionTransformer(img_size=224,
                              patch_size=32,
                              embed_dim=1024,
...
if __name__ == '__main__':
    model = vit_huge_patch14_224_in21k(num_classes=1000)
